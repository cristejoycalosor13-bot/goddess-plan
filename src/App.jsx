...
const SEARCH_INDEX = [
  { label: 'Monday — Glutes & Quads', hint: 'Workouts · Squat · Bulgarian · Hip Thrust', section: 'workout', scrollTo: 'day-monday'    },
  { label: 'Tuesday — Upper Body A',  hint: 'Workouts · Back, Shoulders & Core · Rope · Walk', section: 'workout', scrollTo: 'day-tuesday'   },
  { label: 'Wednesday — Glute Isolation', hint: 'Workouts · Kickback · Abduction · Kas', section: 'workout', scrollTo: 'day-wednesday' },
  { label: 'Thursday — Upper Body B', hint: 'Workouts · Back, Shoulders & Core · Rope · Walk', section: 'workout', scrollTo: 'day-thursday'  },
  { label: 'Friday — Glutes & Hamstrings', hint: 'Workouts · RDL · Hamstring Curl',      section: 'workout', scrollTo: 'day-friday'    },
  ...
  { label: 'Barbell Back Squat',      hint: 'Workouts → Monday Glutes & Quads', section: 'workout', scrollTo: 'day-monday'    },
  { label: 'Barbell Hip Thrust',      hint: 'Workouts → Monday Glutes & Quads', section: 'workout', scrollTo: 'day-monday'    },
  { label: 'Romanian Deadlift',       hint: 'Workouts → Friday Glutes & Hamstrings', section: 'workout', scrollTo: 'day-friday' },
  ...
  { label: 'Kas Glute Bridge',        hint: 'Workouts → Wednesday Glute Isolation', section: 'workout', scrollTo: 'day-wednesday' },
  { label: 'Hamstring Curl',          hint: 'Workouts → Friday Glutes & Hamstrings', section: 'workout', scrollTo: 'day-friday' },
  { label: 'Cable Pull-Through',      hint: 'Workouts → Friday Glutes & Hamstrings', section: 'workout', scrollTo: 'day-friday' },
  { label: 'Shoulder Pain — Rehab Exercises', hint: 'Workouts → Tuesday Upper Body A', section: 'workout', scrollTo: 'day-tuesday' },
  { label: 'Band Pull-Apart & Wall Angel',    hint: 'Workouts → Tuesday Upper Body A', section: 'workout', scrollTo: 'day-tuesday' },
  { label: 'Rotator Cuff — External Rotation', hint: 'Workouts → Upper Body days',     section: 'workout', scrollTo: 'day-tuesday' },
  { label: 'Back Exercises — Rows & Pulldowns', hint: 'Workouts → Upper Body days',     section: 'workout', scrollTo: 'day-tuesday' },
  { label: 'Face Pull & Prone T/W Raise',     hint: 'Workouts → Thursday Upper Body B', section: 'workout', scrollTo: 'day-thursday' },
